...
<%
	...
	String filePath = config.getServletContext().getRealPath("/webtoonDB/list/notice");
	...
	int noticeNum = Integer.parseInt( mul.getParameter("noticeNum"));
	...
	bean.setNum(noticeNum); // 번호

	//이미지 정렬을 위해 기존 값을 가져옴
	ListBean loadimg = dao.getNotice(noticeNum);
	...
	//System.out.println(filePath +"\\" + noticeNum);
	//파일 정보 호출
	newf = new File(filePath +"\\" + noticeNum);
...
<script type="text/javascript">
	alert("<%=msg%>");
	location.href="<%=contextPath%>/noticeList.jsp?noticeNum=<%=noticeNum%>";
</script>
