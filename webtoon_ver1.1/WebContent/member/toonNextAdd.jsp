...
<%
	...
	int NextNum = toondao.getNextEpisode(workNum);
	if (NextNum <=0){
		NextNum  = 1;
	}
...
<script type="text/javascript">
	...
	//첨부 파일 추가
	var rowIndex = 1;
	var max = 8 //추가 할 수 있는 수량은 최대 10으로 한정
	function addFile(){
...
<div class ="content-grid">
	<form method="post" action="toonNextAddPro.jsp" enctype="multipart/form-data">
				...
				<ul class="list-group">
					...
					<li class="list-group-item">
					  	<div class ="row">
					  		...
					  		<div class = "col-sm-6">
					  			<input type="hidden" name ="episode" value="<%=NextNum%>">
						  			<input type="text" class="form-control" value ="<%=NextNum%>" disabled>
					  		</div>
					  	</div>
					</li>
					<li class="list-group-item">
